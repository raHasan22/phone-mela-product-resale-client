...
import iphone from '../../../assets/catagories/iphone.jpg';
import android from '../../../assets/catagories/android.jpg';
import tablet from '../../../assets/catagories/tablet.jpg';
import { Link } from 'react-router-dom';

const Catagories = () => {
    return (
        <div className='mx-5 max-w-[1200px] lg:mx-auto'>
        <div className='mb-5'>
            <h2 className='text-4xl text-center font-bold'>Product Catagories</h2>
        </div>
        <div className="flex items-center justify-center bg-neutral-800">
            <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                    ...
                    <button className="rounded-full bg-cyan-700 hover:bg-sky-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60"><Link to='/android'>See more</Link></button>
                </div>
                </div>
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-lg">
                <div className="">
                ...
                <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                    ...
                    <button className="rounded-full bg-cyan-700 hover:bg-sky-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60"><Link to='/ios'>See more</Link></button>
                </div>
                </div>
                <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 rounded-lg">
                <div className="">
                ...
                <div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
                    ...
                    <button className="rounded-full bg-cyan-700 hover:bg-sky-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60"><Link to='/tablet'>See more</Link></button>
                </div>
                </div>
            </div>
            </div>
